...
One unique and key aspect of VOTES is that it offers to the voter a special ballot paper receipt that contains a cryptographically sealed and anonymous slice of the specific live and local ballot and election data.  This places in the hands of the voter critical evidence of the election as well as their specific ballot all in an anonymous manner.
